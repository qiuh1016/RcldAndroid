...
//        });
         ...
         *  原本船信息的内容
         */
        mapView = (MapView) findViewById(R.id.baiduMapInVisaActivity);
        showShipLocationImageButton = (ImageButton) findViewById(R.id.showShipLocationImageButtonInVisaActivity);
        showShipLocationImageButton.setOnClickListener(this);

        baiduMap = mapView.getMap();
        baiduMap.setOnMarkerClickListener(this);

        toast =  Toast.makeText(VisaActivity.this, "", LENGTH_SHORT);
...
//        getMenuInflater().inflate(R.menu.visa, menu);
        return true;
    }
...
//            mapMark(Lat, Lng);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.showShipLocationImageButtonInVisaActivity:
